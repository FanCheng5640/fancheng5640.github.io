...
<ul class="site-news">
  <li class="site-news__item site-news__item--key site-news__item--award"><span class="site-news__award-layout"><span class="site-news__award-copy">2026-03: <strong>Award:</strong> <a href="/cv/#award-student-excellence-gertner">Student Excellence Award</a> from <span class="text-nowrap">The Marian Gertner Institute</span> for <span class="text-nowrap">Medical Nanosystems</span>.</span> {% include gertner-award-brand.html link=false title="Gertner Scholars" variant="two-line" %}</span></li>
